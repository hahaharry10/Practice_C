...
inlineWay:	file format elf64-littleaarch64
...
Idx Name               Size     VMA              Type
 ...
 13 .text              00000174 0000000000000600 TEXT
 14 .fini              00000018 0000000000000774 TEXT
 15 .rodata            00000004 000000000000078c DATA
 16 .eh_frame_hdr      0000003c 0000000000000790 DATA
 ...
 27 .strtab            00000230 0000000000000000 
...
0000000000000728 <main>:
     ...
     744: 37000128     	tbnz	w8, #0x0, 0x768 <main+0x40>
     748: 14000001     	b	0x74c <main+0x24>
     74c: b9402be8     	ldr	w8, [sp, #0x28]
     750: 11000509     	add	w9, w8, #0x1
     754: b9002be9     	str	w9, [sp, #0x28]
     758: b9802bea     	ldrsw	x10, [sp, #0x28]
     75c: 910003e9     	mov	x9, sp
     760: b82a7928     	str	w8, [x9, x10, lsl #2]
     764: 17fffff5     	b	0x738 <main+0x10>
     768: 2a1f03e0     	mov	w0, wzr
     76c: 9100c3ff     	add	sp, sp, #0x30
     770: d65f03c0     	ret

Disassembly of section .fini:

0000000000000774 <_fini>:
     774: d503233f     	paciasp
     778: a9bf7bfd     	stp	x29, x30, [sp, #-0x10]!
     77c: 910003fd     	mov	x29, sp

0000000000000780 <$x>:
     780: a8c17bfd     	ldp	x29, x30, [sp], #0x10
     784: d50323bf     	autiasp
     788: d65f03c0     	ret
